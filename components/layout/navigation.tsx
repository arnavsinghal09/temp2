...
export function TopNavigation({ activeTab, setActiveTab, tabs, currentUser, onUserChange }: NavigationProps) {
  const [showAccountInfo, setShowAccountInfo] = useState(false)
  const [accountInfoPosition, setAccountInfoPosition] = useState({ x: 0, y: 0 })
        ...
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              <AccountSwitcher currentUser={currentUser} onUserChange={onUserChange} />
...
export function NavigationBar({
  ...
  currentUser,
}: { onNavigateToSettings: () => void; currentUser: User | null }) {
      ...
      <div className="flex items-center justify-between mb-6 bg-gray-950 rounded-lg p-4">
        ...
        <div className="flex items-center space-x-4">
          {currentUser && (
            ...
            >
              <span className="text-black font-bold">{currentUser.name.charAt(0)}</span>
            </div>
          )}
